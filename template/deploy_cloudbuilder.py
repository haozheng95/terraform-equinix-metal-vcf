...
def main():
    ...
    ovf_handle = OvfHandler("http://build-squid.eng.vmware.com/build/storage61/release/bora-16961769/publish/cloud-builder/exports/ova/VMware-Cloud-Builder-4.1.0.0-16961769_OVF10.ova")
    # ovf_handle = OvfHandler("/Users/yhaozheng/Downloads/local_VMware-Cloud-Builder-4.1.0.0-16961769_OVF10.ova")
    ...
    cisp = vim.OvfManager.CreateImportSpecParams(
        ...
        # propertyMapping=myproperty,
        # {"Hostname": "cloudbuilder",
        #    "Admin Username": "admin",
        #    "Admin Password": "VMware1!",
        #    "Root Password": "VMware1!",
        #    "Network 1 IP Address": "172.16.11.10",
        #    "Network 1 Subent Mask": "255.255.255.0",
        #    "Default Gateway": "172.16.11.253",
        #    "DNS Servers": "172.16.11.4",
        #    "DNS Domain Name": "sfo.rainpole.io",
        #    "DNS Domain Search Paths": "sfo.rainpole.io",
        #    "NTF Servers": "172.16.11.253"}
    )
