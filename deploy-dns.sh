...
#todo run nslookup sfo01-m01-esx01.sfo.rainpole.io 127.0.0.1 with python on VM vcf-mgmt-dns as a checkpoint
#python pkg refer https://pythonhosted.org/pyvbox/readme.html